...
In a recent research study (Evans-Powell et al., submitted), a model was developed for estimating time and duration of spawning, and how this differs with respect to female fish length. The proportion of female fish, of a given size, identified as ‘spawning capable’ (i.e. possessing ovaries that, on the basis of macroscopic and/or histological examination, are classified as mature/spawning) on any day of the year is described using a bell-shaped curve. The effect of female length on spawning magnitude and duration is incorporated in the model by modifying the width and height of a ('bell-shaped') double logistic curve in accordance with fish length. The proportion of spawning capable females on a given day during the year is estimated as
...
Evans-Powell, R., Hesp, S. A., Denham, A., Beckley, L. E. (2023). Implications of big, old, fat, fecund female fish (BOFFFFs) in sustaining a large demersal teleost species. Submitted.
