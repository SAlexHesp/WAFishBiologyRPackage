...
$$
\lambda=\frac{n}{2}\bigg[\ln(2\pi)+2\ln(\hat{\sigma})+1\bigg] + \frac{1}{2}\ln(2\pi\sigma^2_p)+\frac{(t_0-\hat{t}_0)^2}{2\sigma^2_1} + \frac{1}{2}\ln(2\pi\sigma^2_p)+\frac{(L_{\infty}-\hat{L}_{\infty})^2}{2\sigma^2_2}
$$
where $t_0$ and $L_{\infty}$ are the values for the hypothetical age at zero length and asymptotic length parameters being estimated, respectively, $\hat{t}_0$ and $\hat{L}_{\infty}$ are the mean values for the priors for these respective parameters (as inputted by the user) and $\sigma_1$ and $\sigma_2$ is their standard deviations (also inputted by the user). 
